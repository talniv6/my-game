...
public class BetaMain extends Scene {
    ...
    private void create(){
        ...
        oldman.setText(new TextGraph("beta/exampletext.txt"));
        ...
        blondman.setText(new TextGraph("beta/blondmantext.txt"));
    ...
    private boolean checkTurningToPersons(){
        if (oldman.playerTurn()){
            ...
            Game.ui.showText(oldman.getText());
            return true;
        }
        else {
            oldman.setDirection(MapObject.RIGHT);
        ...
        if (blondman.playerTurn()){
            ...
            Game.ui.showText(blondman.getText());
            return true;
        }
        else {
            blondman.setDirection(MapObject.RIGHT);
